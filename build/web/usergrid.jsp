                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <%
                            ...
                            {
                                registrationBean rb1 = (registrationBean)al.get(i);
                        %>        
                            <tr>
                                <td><%=rb1.getUserName()%></td>
                                <td><%=rb1.getAddress()%></td>
                                <td><%=rb1.getCity()%></td>
                                <td><%=rb1.getState()%></td>
                                <td><%=rb1.getCountry()%></td>
                                <td><%=rb1.getGender()%></td>
                                <td><%=rb1.getFirstName()%></td>
                                <td><%=rb1.getLastName()%></td>
                                <td><%=rb1.getDate()%></td>
                                <td><%=rb1.getEmail()%></td>
                                <td><%=rb1.getContact()%></td>
                                <td><%=rb1.getUserType()%></td>
