...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini" onload="getServiceProvider();">
    <div class="wrapper">
              ...
              <div class="box box-primary">
                ...
                <form role="form" action="vehicle" >
                  <div class="box-body">
                      ...
                      <input type="text" class="form-control" id="permitno" name="permitno" placeholder="Permit No.">
                    </div>
                      <div class="form-group">
