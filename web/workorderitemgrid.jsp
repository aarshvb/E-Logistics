<%-- 
    Document   : workordergrid
    Created on : Mar 7, 2016, 7:15:37 AM
    Author     : aarsh
--%>

<%@page import="bean.woitemBean"%>
...
<html>
  <head>
    ...
    <!-- DataTables -->
    <link rel="stylesheet" href="admincss/plugins/datatables/dataTables.bootstrap.css">
    <!-- Theme style -->
  ...
  <%
      String woid="";
      if(request.getParameter("workorderid")!=null)
      {
          woid=request.getParameter("workorderid");
      }
      ...
      woarr.setWoId(Integer.parseInt(woid));
      ArrayList a3=woarr.editWorkOrder(con);
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <!-- Main content -->
        <form method="get" action="editworkorder">
             ...
             <!-- /.box -->
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Work Order Item Edit</h3>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <%
                            ...
                            {
                               woitemBean w1=(woitemBean)a3.get(i);
                                
                               {
                        %>
                            <tr>
                                <th><input type="checkbox" name="chk<%=i%>" value="<%=w1.getWoItemId()%>"></th>
                                <td><label name="label"><%=w1.getWoItemId()%></label></td>
                                <td><input type="text" name="itemname<%=i%>" value="<%=w1.getItemName()%>"></td>
                                <td><input type="text" name="qty<%=i%>" value="<%=w1.getQuantity()%>"></td>
                                <td><input type="text" name="unit<%=i%>" value="<%=w1.getUnit()%>"></td>
    ...
    <script src="admincss/plugins/datatables/dataTables.bootstrap.min.js"></script>
    <!-- SlimScroll -->
