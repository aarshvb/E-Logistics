          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <form role="form" action="location" >
                  <div class="box-body">
                    
                      <div class="form-group">
                      <label for="exampleInputPassword1">Address</label>
                      <textarea name="address" rows="10" cols="10" class="form-control"></textarea>
                    </div>
                      <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="contactp" name="contactperson" placeholder="Contact Person">
                      </div>
                      <div class="form-group">
                      <label for="exampleInputEmail1">Contact Number</label>
                      <input type="text" class="form-control" id="contactno" name="contactno" placeholder="Last Name">
                      </div>
