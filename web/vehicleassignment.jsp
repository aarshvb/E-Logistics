...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini" onload="getVendor();" >
    <div class="wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <form role="form" action="vehicleassignment">
                  <div class="box-body">
                    
                       
                      <div class="form-group">
                      <label for="exampleInputEmail1">Vendor </label>
                      <select name="vendor" id="vendor" onblur="getWorkorder();" >
                        
                      </select>
                      </div>
                      <div class="form-group">
                      <label for="exampleInputEmail1">Work Order </label>
                      <select name="workorder" id="workorder" onblur="getServiceProvider()" >
                      ...
                      <select name="serviceprovider" id="serviceprovider" onblur="getWorkOrderItem();" >
                ...
                <div class="box-body">
                  <table id="vehicleassignmenttable" class="table table-bordered table-striped">
